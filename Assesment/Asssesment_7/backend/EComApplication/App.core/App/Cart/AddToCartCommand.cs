...
namespace App.core.App.Cart
{
    ...
    public class AddToCartCommandHandler : IRequestHandler<AddToCartCommand, object>
    {
        ...
        public async Task<object> Handle(AddToCartCommand request, CancellationToken cancellationToken)
        {
            ...
            var checkUserId = await _appDbContext.Set<Domain.Entity.Products.CartMaster>()
            ...
            if (checkUserId is null)
            {
                ...
                await _appDbContext.Set<Domain.Entity.Products.CartMaster>()
                              .AddAsync(cartMaster);
            ...
            await _appDbContext.Set<Domain.Entity.Products.CartDetails>()
